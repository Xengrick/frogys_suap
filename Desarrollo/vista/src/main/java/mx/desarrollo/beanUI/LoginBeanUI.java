...
public class LoginBeanUI implements Serializable {
    ...
    /**
     * Método postconstructor, todo lo que esté dentro de este método
     * será lo primero que haga cuando cargue la página.
     */
    @PostConstruct
    public void init() {
        usuario = new Usuario();
    ...
    public void login() throws IOException {
        ...
        Usuario us = loginHelper.Login(usuario.getClave(), usuario.getNombreUsuario());
